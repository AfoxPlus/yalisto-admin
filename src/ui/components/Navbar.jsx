...
export const Navbar = () => {
  return (
    <nav className="navBar">
      <Link to={"/"}>
        <img src="/public/assets/logo.svg" alt="" className="logo-img" />
      </Link>
